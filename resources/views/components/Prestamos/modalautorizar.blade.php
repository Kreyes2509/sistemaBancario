<div class="modal fade" id="autorizarModal-{{$row->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" action="{{url('prestamos',[$row->prestamoID])}}">
                @method('PUT')
                @csrf
                <div>
                ...
                <div>
                    <h5>¿Autorizar el siguiente prestamo?</h5>
                </div><br>
