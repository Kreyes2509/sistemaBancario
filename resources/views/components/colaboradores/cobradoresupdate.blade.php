 ...
 <div class="modal fade" id="updateModal-{{$row->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" action="{{url('cobradores',[$row->id])}}">
                @method('PUT')
                @csrf
                ...
                <div class="input-group mb-3">
                  ...
                  <div class="input-group mb-3">
                    <span class="input-group-text"><i class="fa-solid fa-graduation-cap"></i></span>
                    <input value="{{$row->email_empresa}}" type="text" name="email_empresa" class="form-control" placeholder="correo empresarial" aria-label="Username" aria-describedby="basic-addon1">
                </div>
