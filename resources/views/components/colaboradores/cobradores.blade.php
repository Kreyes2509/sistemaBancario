...
<body>
                    ...
                    @foreach ($cobradores as $row)
                        <tr>
                            ...
                            <td>
                                ...
                                @include('components.colaboradores.cobradoresupdate')
                            ...
                            <td>
                                ...
                                @include('components.colaboradores.cobradoresdelete')

                            </td>
                            <td>
                                <a href="{{url('clientecobrador',[$row->id])}}"class="btn btn-warning">Clientes</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
    ...
    @include('components.colaboradores.cobradoresadd')
